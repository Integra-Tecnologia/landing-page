    ...
    <footer className="bg-slate-900 text-gray-300 py-12 font-sans border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 lg:gap-12">
          ...
          <div className="flex flex-col space-y-4">
            <Link to="/" onClick={() => window.scrollTo(0, 0)}>
              <img 
                src={LogoBlanco} 
                alt="Logo Integra" 
                className="h-45 w-auto object-contain object-left -my-15" 
              />
            </Link>
            <p className="text-md text-gray-400 max-w-sm mt-2">
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="text-white font-bold text-lg tracking-wide uppercase ">Contacto</h3>
            <ul className="space-y-3 text-md">
              <li className="flex items-start gap-3">
                <FaMapPin className="text-primary text-lg" />
                <span>
                  Roberto Astiázaran #665 Col. Los Viñedos, Hermosillo, Sonora, México. C.P. 83128
                </span>
              </li>
              ...
              <li className="flex items-center gap-3 hover:text-white transition-colors">
                ...
                <a href="mailto:contacto@integra.com.mx">contacto@integran.mx</a>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="text-white font-bold text-lg tracking-wide uppercase ">Síguenos</h3>
            <div className="flex gap-4 mt-2">
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61589691844431&locale=es_LA" rel='noopener' target="_blank" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all duration-300">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/integranmx/" rel='noopener' target="_blank" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all duration-300">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
