        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 lg:gap-12">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex gap-4 mt-2">
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61589691844431&locale=es_LA" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all duration-300">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/integranmx/" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all duration-300">
                <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
